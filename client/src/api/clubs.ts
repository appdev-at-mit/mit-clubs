 ...
 */
export async function saveClub(clubId: string): Promise<Club> {
 ...
 */
export async function unsaveClub(clubId: string): Promise<Club> {
 ...
 */
export async function getSavedClubs(): Promise<Club[]> {
 ...
 */
export async function getSavedClubIds(): Promise<{ club_id: string }[]> {
 ...
 */
export async function getID(clubId: string): Promise<Club> {
 ...
 */
export async function getUserMemberships(): Promise<{ data: Club[] }> {
